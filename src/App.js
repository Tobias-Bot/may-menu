            ...
            <HashRouter>
              ...
              >
                <Switch>
                  ...
                  <Route path="/may-playlists">
                    <PlaylistsPage />
                  </Route>
                  <Route path="/may-streams">
                    <StreamsPage />
                  </Route>
                  <Route path="/may-apps">
                    <AppsPage />
              ...
              <div className="footer">
                ...
                <a className="linkStyle" href="https://vk.com/app7297645_-160404048">
                  <div className="btnFooterMain">
                    <i className="fas fa-pencil-alt"></i>
                    <div className="btnFooterMainTitle">статья</div>
                  </div>
                </a>
