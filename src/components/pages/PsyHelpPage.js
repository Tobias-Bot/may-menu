  ...
  render() {
    return (
      <div>
        ...
        <br />
        <div className="pageHint">Дополнительные службы</div>
        <div className="pageHint" style={{ fontSize: "15px", opacity: "0.6" }}>
          8-800-2000-122 — телефон доверия, круглосуточно. Телефон доверия
          твоего города можно посмотреть в Интернете. Для получения
          неотложной медицинской помощи позвонить по номеру экстренной помощи
          112. Звонок с мобильного возможен, даже если номер заблокирован.
        </div>
      </div>
    );
  }
