!(function () {
  ...
  function d() {
    ...
    var o = Array(e),
      r = 0;
    for (n = 0; n < t; n++)
      for (var p = arguments[n], i = 0, a = p.length; i < a; i++, r++)
        o[r] = p[i];
    return o;
  }
  function s(p, e) {
      ...
      function (o, r) {
        return (
          ...
          new Promise(function (e, n) {
            var t = i.add({ resolve: e, reject: n }, r.request_id);
            p(o, a(a({}, r), { request_id: t }));
          })
        );
      }
    );
  ...
  var e = "undefined" != typeof window,
    u = Boolean(e && window.AndroidBridge),
    b = Boolean(
      e &&
        window.webkit &&
    ...
    A = e ? window.AndroidBridge : void 0,
    w = b ? window.webkit.messageHandlers : void 0;
  function t(e, n) {
  ...
  "undefined" == typeof window ||
    window.CustomEvent ||
    (window.CustomEvent = ((t.prototype = Event.prototype), t));
  var o = (function (t) {
    var p = void 0,
      i = [];
    function e(e) {
    ...
    "undefined" != typeof window &&
      ...
      window.addEventListener(c, function (n) {
        if (b || u)
          return d(i).map(function (e) {
        ...
        if (l && n && n.data) {
          var e = n.data,
            ...
            o = e.data,
            r = e.frameId;
          t && "VKWebAppSettings" === t
            ? (p = r)
            : d(i).map(function (e) {
                return e({ detail: { type: t, data: o } });
              });
        }
      });
    var a = s(function (e, n) {
      A && A[e]
        ...
        : w && w[e] && "function" == typeof w[e].postMessage
        ? w[e].postMessage(n)
        : l &&
          parent.postMessage(
            {
